...
As a group, students should take about 15 minutes to create a rough diagram showing a system for testing individuals **within their state jurisdiction only** for the Z virus. Use as few words as possible in each sketch, relying instead on **simple symbols** (arrows, stick figures etc.).
...
* How do you make sure you're testing enough people?
